...
export default function HeroSection() {
  return (
    <div className="h-[25rem] md:h-[33rem] lg:h-[40rem] w-full  rounded-md flex md:items-center    dark:bg-dot-white/[0.2] bg-dot-black/[0.2] md:justify-center antialiased  relative overflow-hidden">
      ...
      <div className=" p-4 max-w-6xl z-20  mx-auto relative   w-full pt-20 md:pt-0">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-400 to-primary bg-opacity-50">

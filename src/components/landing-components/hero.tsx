...
export default function HeroSection({ id }: { id?: string }) {
  return (
    <div
      id={id}
      className="relative flex h-[25rem] w-full flex-col overflow-hidden rounded-md antialiased bg-dot-black/[0.2] dark:bg-dot-white/[0.2] md:h-[33rem] md:items-center md:justify-center lg:h-[40rem]"
    >
      <div className="pb-4">
